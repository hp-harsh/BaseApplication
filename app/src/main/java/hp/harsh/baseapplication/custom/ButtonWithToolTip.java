...
public class ButtonWithToolTip extends Button {
    ...
    public ButtonWithToolTip(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ButtonWithToolTip(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(21)
    public ButtonWithToolTip(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
